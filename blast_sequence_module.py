# -*- coding: utf-8 -*-
"""blast_sequence_module.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1W59i-i8rRRZpf7zM9u2pl1mbNKytvmfc
"""
...
def blast_sequence(fasta_file, idx):
    ...
    with open(result_file) as result_handle:
        ...
        for hit in hits:
            if len(top_hits) >= 3: # This decides how many top hits you want
                break
...
if __name__ == "__main__":
    n = 2 # Change the value of n based on number of sequences that need to be processed
    fasta_file = "result (1).fasta"  # Replace with your FASTA formatted file path
    ...
    for i in range(n):
      lst = blast_sequence(fasta_file, i)
